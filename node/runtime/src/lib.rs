...
impl pallet_staking::Config for Runtime {
	...
	type BenchmarkingConfig = BenchmarkStakingConfig;
}
...
pub struct BenchmarkStakingConfig;
impl pallet_staking::BenchmarkingConfig for BenchmarkStakingConfig {
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		AssetTxPayment: pallet_asset_tx_payment::{Pallet, Storage},
		...
		Gilt: pallet_gilt::{Pallet, Call, Storage, Event<T>},
		Uniques: pallet_uniques::{Pallet, Call, Storage, Event<T>},
		TransactionStorage: pallet_transaction_storage::{Pallet, Call, Storage, Event<T>},
